...
(custom-set-variables
 ...
 '(align-c++-modes
   (quote
    (c++-mode c-mode java-mode js2-mode sql-mode js-mode)))
 ...
 '(flycheck-disabled-checkers (quote (javascript-eslint javascript-gslint)))
 ...
 '(js2-imenu-enabled-frameworks (quote (jquery backbone)))
 ...
 '(magit-diff-auto-show (quote (commit log-oneline log-select blame-follow)))
 ...
 '(projectile-globally-ignored-directories (quote (".git" ".hg" ".svn")))
 '(projectile-globally-ignored-file-suffixes (quote (".exe" ".pyc" ".pyo" ".dll")))
 '(projectile-globally-ignored-files (quote ("TAGS" ".DS_Store" "*.pdf" "*.elc")))
...
(custom-set-faces
 ...
 '(highlight ((t (:background "DeepSkyBlue4" :foreground "white"))))
